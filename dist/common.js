...
const SECTION_CONFIG={
  math_lab:{name:"معمل الرياضيات",icon:"＋",path:"/math-lab",page:"math",item:"نشاط",items:"الأنشطة",heading:"الأنشطة المطلوبة",submitTitle:"إرسال تجربة رياضية",description:"اختاري الفصل لمشاهدة أنشطة الرياضيات وتجارب الطالبات.",emptyTitle:"لا توجد أنشطة مطلوبة حاليًا"},
  research:{name:"البحث العلمي",icon:"🔎",path:"/research",page:"research",item:"طلب بحث",items:"طلبات البحث",heading:"طلبات البحث الحالية",submitTitle:"إرسال بحث علمي",description:"اختاري الفصل لمشاهدة طلبات البحث وتسليم البحث كتابة أو بصورة.",emptyTitle:"لا توجد طلبات بحث حاليًا"},
  school_trip:{name:"رحلة مدرسية",icon:"🚌",path:"/school-trip",page:"trip",item:"فعالية",items:"فعاليات الرحلة",heading:"تفاصيل الرحلة والمهام",submitTitle:"إرسال مشاركة الرحلة",description:"اختاري الفصل لمشاهدة تفاصيل الرحلة والمهام والصور المعتمدة.",emptyTitle:"لا توجد رحلة أو مهام مضافة حاليًا"},
  reading_comprehension:{name:"الفهم القرائي",icon:"📚",path:"/reading",page:"reading",item:"نشاط قرائي",items:"الأنشطة القرائية",heading:"أنشطة الفهم القرائي",submitTitle:"إرسال مشاركة قرائية",description:"اختاري الفصل لمشاهدة النصوص والأسئلة والأنشطة القرائية.",emptyTitle:"لا توجد أنشطة قرائية حاليًا"}
};
...
function initVisionIdentity(){
  ...
  band.innerHTML='<div class="container vision-inner"><img class="vision-logo" src="/vision-2030.jpg" alt="شعار رؤية السعودية 2030" loading="lazy"><div class="vision-copy"><strong>تعليم طموح لمستقبل مزدهر</strong><span>نلهم طالباتنا للتعلّم والإبداع والمشاركة</span></div></div>';
  footer.before(band);
}
